...
;
let maxProductTest1 = [2, 3, -2, 4]; // 6
let maxProductTest2 = [1, -2, -3, -4]; // 12
let maxProductTest3 = [-1, -2, -3, 4]; // 24
let maxProductTest4 = [-2, 0, -1]; // 0
let maxProductTest5 = [2, -5, 3, 1, -4, 0, -10, 2, 8]; // 
