 ...
 */
//time => o(n2) space => o(n)
function dailyTemperatures_brute_On2(temperatures) {
    let res = [];
    for (let today = 0; today < temperatures.length; today++) {
        for (let forecastedWarmerDay = today + 1; forecastedWarmerDay < temperatures.length; forecastedWarmerDay++) {
...
let dailyTemperatures1 = [73, 74, 75, 71, 69, 72, 76, 73]; // [1,1,4,2,1,1,0,0]
let dailyTemperatures2 = [30, 40, 50, 60]; // [1,1,1,0]
let dailyTemperatures3 = [30, 60, 90]; // [1,1,0]
